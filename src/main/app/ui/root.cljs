...
(defsc MyClassesPage [this {:component/keys [classes] :as props}]
  {:query [{:component/classes (comp/get-query ClassListItem)}]
...
(defsc Session
  ...
  {:query         [:session/valid? :account/name :account/id]
